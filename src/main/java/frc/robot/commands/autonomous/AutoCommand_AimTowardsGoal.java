...
public class AutoCommand_AimTowardsGoal extends CommandBase {
  ...
  public AutoCommand_AimTowardsGoal(double s) {
    speed = s;
  ...
  public void execute() {
    ...
    double currentPos = Robot.m_limelightWrapper.tx.getDouble(0.0);
